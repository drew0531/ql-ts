...
update_qinglong() {
    ...
    reset_romote_url ${dir_root} "${github_proxy_url}https://github.com/drew0531/ql-ts.git"
    ...
    local url="${github_proxy_url}https://github.com/drew0531/qinglong-static.git"
